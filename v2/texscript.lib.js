...
`});async function ze(){let t=document.createElement("progress");t.setAttribute("class","texscript-splash-progress-bar"),t.setAttribute("id","texscript-splash-progress"),t.setAttribute("value","0"),t.setAttribute("max","100"),document.body.appendChild(t),await(await Promise.resolve().then(()=>(A(),ie))).loadSplash()}export{ze as load};
