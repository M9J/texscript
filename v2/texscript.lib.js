...
${n}`;if(o)return o;if(n)return n}var W=u(()=>{"use strict";A();w()});var Y={};f(Y,{loadTexscriptStyles:()=>de});async function de(){let t=document.querySelector('script[src$="texscript.js"]');if(t instanceof HTMLScriptElement&&t.src){let e=t.src.replace("texscript.js","texscript.css");await ue(e),await me()}}async function ue(t){try{let e=await fetch(t);if(e){let s=await e.text();if(s){let o=document.createElement("style");o.innerHTML=s,document.head.appendChild(o)}}}catch(e){l(e,"error"),console.log(e)}}async function me(){let t=document.createElement("meta");t.setAttribute("name","viewport"),t.setAttribute("content","initial-scale=1.0, maximum-scale=1.0, user-scalable=no"),document.head.appendChild(t)}var Q=u(()=>{"use strict";w()});var k,y,v,b,z=u(()=>{"use strict";A();b=class{constructor(e){x(this,k,null);x(this,y,null);x(this,v,null);if(!e)throw new Error(a.ERR0013);C(this,k,e)}start(){C(this,y,performance.now())}end(){C(this,v,performance.now());let e=this.getFormattedTime();console.log(`[Texscript: Metrics] > ${R(this,k)} finished in ${e}`)}getTotalTimeMilliseconds(){return R(this,v)&&R(this,y)?R(this,v)-R(this,y):0}getFormattedTime(){let e=this.getTotalTimeMilliseconds();return e<1e3?`${e.toFixed(3)}ms`:`${(e/1e3).toFixed(3)}s`}};k=new WeakMap,y=new WeakMap,v=new WeakMap});var O,L,H,M,F,P,V=u(()=>{"use strict";L=class{constructor(e){x(this,O,null);C(this,O,e)}getNodeType(){return R(this,O)}};O=new WeakMap;H=class extends L{constructor(){super("ROOT");this.value=null;this.meta={};this.body=[];this.dependencies={}}},M=class extends L{constructor(){super("TAG");this.value=null;this.htmlElement=null;this.customCSSClasses=[];this.parameters=null;this.children=[]}},F=class extends L{constructor(){super("LITERAL");this.value=null}},P=class extends L{constructor(){super("SPEC_TAG");this.htmlElement=null;this.value=null}}});function Te(t,e){let s=new Map;for(let o of t){let n=o.split("|").map(c=>{let i=e[c];if(!i)throw new Error(`Unknown token: ${c}`);return i.source}),r=new RegExp(n.join(""));s.set(o,r)}return s}var ge,Ee,he,Re,fe,Se,X,Z=u(()=>{"use strict";ge={KEYWORD:/(^[A-Z][a-z]*)/,STRING:/"(.*)"$|(\\\"(.*)\\\"$)/},Ee={CSS_CLASS:/\.([a-z]+[a-zA-Z]*)/,EXTERNAL_REFERENCE:/(@[A-Z][a-zA-Z]*:\s".*")/,PARAMETERS:/(\([\s*\w+:\s*\w+,*\s*]*\))/},he={BRACKET_SQUARE_CLOSE:/(\])/,BRACKET_SQUARE_OPEN:/(\[)/,COLON:/(:)/,SPACE:/(\s)/},Re={BR:/(::)/,HR:/(--)/},fe={...ge,...Ee,...he,...Re},Se=["BR","BRACKET_SQUARE_CLOSE","HR","KEYWORD|COLON|SPACE|STRING","KEYWORD|CSS_CLASS|COLON|SPACE|STRING","KEYWORD|CSS_CLASS|SPACE|BRACKET_SQUARE_OPEN","KEYWORD|CSS_CLASS|SPACE|PARAMETERS|COLON|SPACE|STRING","KEYWORD|CSS_CLASS|SPACE|PARAMETERS|SPACE|BRACKET_SQUARE_OPEN","KEYWORD|SPACE|BRACKET_SQUARE_OPEN","KEYWORD|SPACE|PARAMETERS|COLON|SPACE|STRING","KEYWORD|SPACE|PARAMETERS|SPACE|BRACKET_SQUARE_OPEN","STRING","EXTERNAL_REFERENCE"];X=Te(Se,fe)});var S,q=u(()=>{"use strict";S=class{constructor(){this.items=[]}push(e){this.items.push(e)}pop(){if(this.isEmpty())throw new Error("Stack underflow");return this.items.pop()}isEmpty(){return this.items.length===0}size(){return this.items.length}peek(){return this.isEmpty()?null:this.items[this.items.length-1]}}});var J={};f(J,{default:()=>$});var $,ee=u(()=>{"use strict";z();A();V();Z();q();$=class{constructor(){this.version="v0.2";this.repourl="https://github.com/M9J/texscript.git";this.metricsCompilation=new b("Compilation");this.metricsCodeGeneration=new b("Code Generation");this.rawCode=null;this.loc=null;this.tokens=null;this.ast=null;console.log(`[Texscript: Info] > Compiler ${this.version}`)}toString(){return{version:this.version,repoURL:this.repourl,lastCompilation:new Map([["loc",this.loc],["tokens",this.tokens],["ast",this.ast]])}}compile(e){this.rawCode=e,this.metricsCompilation.start(),this.loc=this.convertToLinesOfCode(),this.tokens=this.lexicalAnalysis(),this.ast=this.syntaxAnalysis(),this.metricsCompilation.end()}generateCodeFor(e){if(!e)throw new Error(a.ERR0011);this.metricsCodeGeneration.start();let s=null;if(e==="HTML")s=this.generateCodeForHTML();else throw new Error(a.ERR0012);return this.metricsCodeGeneration.end(),s}generateCodeForHTML(){if(!this.ast)throw new Error(a.ERR0009);let e="";for(let s of this.ast.body){let o=s.getNodeType();(o==="TAG"||o==="SPEC_TAG"||o==="LITERAL")&&(e+=this.generateHTMLForNode(s))}return e.trim()}generateHTMLForNode(e){if(!e)throw new Error(a.ERR0010);let s=e.getNodeType(),o=e.value,n=e.htmlElement,r=e.parameters,c=e.customCSSClasses,i=e.children||[],g="",E="";if(Array.isArray(c)&&c.length>0&&(g=` ${c.join(" ")}`),r)for(let d in r){let T=r[d];E+=` texscript-${o}-${d.toUpperCase()}-${T.toUpperCase()}`}return s==="TAG"?`<${n} class="texscript-${o}${g}${E}">
...
`).map(e=>e.trim()).filter(e=>e.length>0)}}});var te={};f(te,{process:()=>xe});async function xe(t,e){try{if(l("Compiling..."),t.compile(e),t.ast){let c=t.ast.dependencies;l("Loading dependencies..."),await Ce(c),p("95")}let s=t.generateCodeFor("HTML");l("Compilation done.");let o=document.querySelector(".texscript-banner-container");o instanceof HTMLElement&&(o.style.display="none");let n=document.createElement("div");n.className="texscript-pages",p("100"),n.innerHTML=s;let r=document.createElement("div");r.className="texscript-pages-container",r.appendChild(n),document.body.appendChild(r),window.TexscriptCompiler={...t.toString(),toggleSplashStatus:()=>G()}}catch(s){l(s,"error"),console.log(s)}}async function Ce(t){try{if(t!=null&&t.CustomCSSFilePath){let e=t.CustomCSSFilePath;await Ae(e)}}catch(e){l(e,"error"),console.log(e)}}async function Ae(t){let e=document.createElement("link");e.rel="stylesheet",e.href=t;try{document.head.appendChild(e),await new Promise((s,o)=>{e.onload=()=>s(),e.onerror=()=>{let n=a.ERR0018+"<br/>"+t;o(new Error(n))}})}catch(s){l(s,"error"),console.log(s)}}var se=u(()=>{"use strict";A();w()});var re={};f(re,{load:()=>we});async function we(){try{l("Getting handy tools..."),p("20");let t=await Promise.resolve().then(()=>(W(),j)),e=await Promise.resolve().then(()=>(Q(),Y));l("Opening curse words..."),p("30");let s=await Promise.resolve().then(()=>(A(),U));l("Applying beauty makeup..."),p("40"),await e.loadTexscriptStyles(),l("Loading brain power..."),p("50");let o=await Promise.resolve().then(()=>(ee(),J)),n=new o.default,r=await Promise.resolve().then(()=>(se(),te));p("60"),l("Finding your story...");let c=await t.findCodeFromDOM();if(!c)throw new Error(s.default.ERR0001);p("90"),r.process(n,c)}catch(t){l(t,"error"),console.log(t)}}var oe=u(()=>{"use strict";w()});var ie={};f(ie,{hideSplashProgress:()=>ne,loadSplash:()=>Le,toggleSplashStatus:()=>G,updateSplashProgress:()=>p,updateSplashStatus:()=>l});async function Le(){try{p("8");let t=document.createElement("style");t.innerHTML=be,document.head.appendChild(t);let e=document.createElement("div");e.innerHTML=ve,document.body.appendChild(e),l("Fetching Texscript Loader...");let s=await Promise.resolve().then(()=>(oe(),re));p("10"),l("Fetched Texscript Loader"),l("Loading Texscript modules..."),await s.load()}catch(t){l(t,"error"),console.log(t)}}function l(t,e){let s="";e==="error"?s=(r=>`<div class="texscript-splash-status-${r}">${t}</div>`)("error"):s=t;let n=document.getElementById("texscript-splash-status");if(n&&(c=>{n.innerHTML+=c+"<br/>"})(s),e&&["error"].includes(e)){let r=document.getElementById("texscript-splash");r&&(r.style.display="flex")}}function G(){let t=document.getElementById("texscript-splash");t&&(t.style.display=t.style.display==="flex"?"none":"flex")}function p(t){if(t){let e=document.getElementById("texscript-splash-progress");e&&e.setAttribute("value",t),parseInt(t)>99&&ne()}}function ne(){let t=document.getElementById("texscript-splash-progress");t&&(t.style.display="none")}var ye,ve,be,w=u(()=>{"use strict";ye='Texscript Markup Language [Version 0.2]<br/>Free and Open Source. Licensed under GPL-3.0.<br/>Hosted on GitHub: <a href="https://github.com/M9J/texscript.git">texscript.git</a>',ve=`
...
`;async function Ve(){let t=document.createElement("style");t.innerHTML=Ne,document.head.appendChild(t);let e=document.createElement("progress");e.setAttribute("class","texscript-splash-progress-bar"),e.setAttribute("id","texscript-splash-progress"),e.setAttribute("value","0"),e.setAttribute("max","100"),document.body.appendChild(e),e.setAttribute("value","2");let s=await Promise.resolve().then(()=>(w(),ie));e.setAttribute("value","5"),await s.loadSplash()}export{Ve as load};
